    ...
    if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
        ...
        if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
            ...
            if (retcode == SQL_SUCCESS || retcode == SQL_SUCCESS_WITH_INFO) {
                ...
                retcode = SQLConnect(hdbc, (SQLWCHAR*)L"2014180014_ODBC", SQL_NTS, (SQLWCHAR*)NULL, SQL_NTS, NULL, SQL_NTS);
...
bool CDBHandler::IsValidedUserID(string ID)
{
    wstring Query{ L"EXEC IsValidedUserID " + StringToWstring(ID) };
    int Flag{};
    SQLLEN cbFlag{};
